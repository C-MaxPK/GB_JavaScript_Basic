...
let btnElems = document.querySelectorAll('button');
...
function showCategory(category) {
    if (category == 'phones') {
        productsEl.innerHTML = getProductMarkup(products.phones);
    } else if (category == 'tablets') {
        productsEl.innerHTML = getProductMarkup(products.tablets);
    } else if (category == 'tv') {
        productsEl.innerHTML = getProductMarkup(products.tv);
    }
}
...
function getProductMarkup(product) {
    let markupForProduct = '';
    product.forEach (function (element) {
        markupForProduct += `<div class="product">
